...
const AboutSnapshot = ({ imageUrl }: { imageUrl?: string }) => {
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto font-medium">
              We go beyond short-term support. We focus on building long-term
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-gray-50 p-10 rounded-[2rem] border border-gray-100 hover:shadow-xl transition-all group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Equipping widows with practical skills to earn and sustain
                livelihoods
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-10 rounded-[2rem] border border-gray-100 hover:shadow-xl transition-all group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Partnering with communities to create sustainable, long-term
                solutions
              </p>
            </div>
          </div>
      ...
      <section
        id="who-we-serve"
        className="py-24 bg-brand-blue text-white overflow-hidden relative scroll-mt-20"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h1 className="text-white/80 font-bold uppercase tracking-widest mb-4">
                Who We Serve
              </h1>
              ...
              <div className="p-8 bg-white/10 rounded-3xl border border-white/20">
                <p className="text-2xl font-bold italic">
                  &quot;Every person can thrive and unlock endless
                  possibilities.&quot;
                </p>
              </div>
            </div>
