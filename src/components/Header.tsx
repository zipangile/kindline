...
const Header = () => {
  ...
  const navLinks = [
    ...
    { name: "Friends of Kindline", href: "/friends" },
    { name: "News", href: "/news" },
  ...
  return (
    <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 md:py-0">
      <nav
        className="max-w-7xl w-full mx-auto px-4 md:flex md:items-center md:justify-between"
        aria-label="Global"
      >
        <div className="flex items-center justify-between">
          <Link
            href="/"
            className="flex-none relative h-24 w-56"
            aria-label="Kindline Care"
          >
            <Image
              src="/logo.png"
          ...
          <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:ps-7">
            ...
            {!user ? (
              <div className="flex items-center gap-x-3">
                ...
                <Link
                  href="/signup"
                  className="text-gray-700 hover:text-brand-blue font-semibold border-2 border-gray-200 px-4 py-1.5 rounded-full transition-all"
                >
                  Sign up
                </Link>
              </div>
