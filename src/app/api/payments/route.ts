...
export async function POST(request: Request) {
  try {
    ...
    if (!transaction_id || (typeof transaction_id !== 'string' && typeof transaction_id !== 'number') || String(transaction_id).length > SECURITY_LIMITS.ID || !isValidId(String(transaction_id))) {
