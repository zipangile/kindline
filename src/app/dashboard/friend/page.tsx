          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                <Link
                  href="/impact"
                  className="block p-4 bg-white border border-gray-200 rounded-xl hover:border-purple-300 hover:shadow-md transition-all"
                >
