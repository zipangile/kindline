      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            Create and manage your organization&apos;s core initiatives.
          </p>
        </div>
      </div>
              ...
              <tr key={programme.id}>
                ...
                <td className="px-6 py-4 text-right text-sm font-medium">
                  <div className="flex justify-end gap-3">
                    ...
                    <form
                      action={updateProgramStatus.bind(
                        null,
                        programme.id,
                        programme.status === "live" ? "archived" : "live",
                      )}
                      className="inline"
                    >
                      <button
                    ...
                    <form
                      action={deleteProgram.bind(null, programme.id)}
                      className="inline"
                    >
                      <ConfirmButton
                        type="submit"
