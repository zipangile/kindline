...
export default async function AdminPage(props: {
  ...
  try {
    const [programCount, activeCount, donorCount, volunteerCount] =
      await Promise.all([
    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="text-gray-500 mt-1">
          Welcome back. Here&apos;s what&apos;s happening with Kindline Care.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        <div className="xl:col-span-2 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Link
              ...
              className="group flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-orange-200 hover:bg-orange-50 transition-all"
            >
              <div className="flex items-center gap-4">
            ...
            <Link
              ...
              className="group flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-pink-200 hover:bg-pink-50 transition-all"
            >
              <div className="flex items-center gap-4">
            ...
            <Link
              href="/admin/impact"
              className="group flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:border-green-200 hover:bg-green-50 transition-all"
            >
              <div className="flex items-center gap-4">
        ...
        <div className="bg-[#1e293b] p-8 rounded-2xl shadow-sm text-white">
          ...
          <p className="text-gray-400 text-sm mb-6">
            Common tasks you might need to do quickly.
          </p>
          ...
          <div className="space-y-3">
            ...
            <Link
              href="/admin/donors"
              className="block w-full text-center bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-xl transition-colors"
            >
              Verify Transaction
            </Link>
            <Link
              href="/admin/images"
              className="block w-full text-center bg-gray-700 hover:bg-gray-600 text-white font-bold py-3 px-4 rounded-xl transition-colors"
            >
              Update Hero Image
            </Link>
          </div>
