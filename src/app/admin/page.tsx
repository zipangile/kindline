    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">Total Programs</p>
          <p className="text-3xl font-bold text-blue-800 mt-2">{programCount}</p>
        </div>
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <p className="text-sm font-medium text-gray-500 uppercase tracking-wider">Active Programs</p>
      ...
      <div className="mt-12 bg-white p-8 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="flex gap-4">
          <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">Add New Program</button>
