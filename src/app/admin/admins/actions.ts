...
export const ALLOWED_ROLES = ['SUPER_ADMIN', 'CONTENT_EDITOR', 'FINANCIAL_ADMIN', 'VOLUNTEER_COORD'] as const;
...
async function syncUserRole(email: string, role: AdminRole | 'USER' | null) {
