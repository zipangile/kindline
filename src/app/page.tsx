...
export default async function Home(props: {
  ...
  return (
    <div>
      <Hero
        imageUrl={getImage("homepage_hero") || "/images/child-development.jpg"}
      />
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-brand-blue font-bold uppercase tracking-widest mb-4">
              Get in Touch
            </h2>
            <h3 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-8">
              We&apos;d love to hear from you.
            </h3>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto font-medium">
              Whether you want to donate, partner, volunteer, or learn more
              about our work, every message helps us move closer to transforming
              lives in Zambia.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-gray-50 p-10 rounded-[2rem] border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 font-medium">
                For questions about our work and programmes.
              </p>
              <div className="space-y-3">
                <a
                  href="mailto:info@kindlinecare.org"
                  className="flex items-center gap-3 text-brand-blue font-bold hover:underline"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
            ...
            <div className="bg-gray-50 p-10 rounded-[2rem] border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 font-medium">
                For organisations, individuals, and supporters who want to
                contribute or collaborate.
              </p>
              <div className="space-y-3">
                <a
                  href="mailto:partnerships@kindlinecare.org"
                  className="flex items-center gap-3 text-brand-blue font-bold hover:underline"
                >
                  <svg
                    className="w-5 h-5"
              ...
              <div className="space-y-6">
                <div>
                  <p className="text-gray-700 font-medium flex items-start gap-3">
                    <svg
                      className="w-5 h-5 text-brand-blue shrink-0 mt-1"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
