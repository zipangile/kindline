      ...
      <section className="bg-brand-blue text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto font-medium">
            ...
            partner, volunteer, or learn more about our work, every message
            helps us move closer to transforming lives in Zambia.
          </p>
        </div>
      </section>
            ...
            <div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div>
                        <p className="text-sm font-bold text-brand-blue uppercase tracking-wider mb-1">
                          General Enquiries
                        </p>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-gray-700 font-medium">
                      ...
                      <p className="text-sm text-gray-500 italic">
                        Service Area: 10 Miles, Chibombo District, Central
                        Province
                      </p>
                    </div>
                  </div>
              ...
              <div className="mt-16 p-10 bg-gray-50 rounded-[2rem] border border-gray-100">
                ...
                <div className="flex space-x-4">
                  <div className="w-10 h-10 bg-blue-800 rounded-full flex items-center justify-center text-white font-bold cursor-pointer hover:bg-blue-900 transition-colors">
                    f
                  </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                        <div>
                          ...
                          <input
                            ...
                            name="firstName"
                            id="firstName"
                            className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-brand-blue focus:ring-brand-blue disabled:opacity-50"
